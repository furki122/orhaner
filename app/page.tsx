...
export default function OrhanerArtistWebsite() {
  ...
  const tracks = [
    {
      title: "NASIL BAŞARDIN",
      type: "Official Video",
      duration: "3:20",
      url: "https://www.youtube.com/watch?v=fqv5Llch34o",
    },
    {
      title: "Kalp Yarası",
      type: "Official Video",
      duration: "3:11",
      url: "https://www.youtube.com/watch?v=PjcTzmPsTtI",
    },
    {
      title: "Farklı Biri",
      type: "Official Video",
      duration: "3:35",
      url: "https://www.youtube.com/watch?v=rkwtKr33SAY",
    },
    {
      title: "Çıkmaz Yolum",
      type: "Official Video",
      duration: "3:08",
      url: "https://www.youtube.com/watch?v=eMZbK5YQH9Y",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white selection:bg-white selection:text-black">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/50 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-10">
          <div className="flex items-center justify-between gap-4">
            <div>
              <div className="text-xl font-black tracking-[0.32em] sm:text-2xl">
                ORHANER
              </div>
            ...
            <nav className="hidden gap-6 text-sm text-white/70 lg:flex">
              ...
              <a
                href="https://www.youtube.com/@orhaner11"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://www.instagram.com/orhaner___?hl=de"
                target="_blank"
                rel="noreferrer"
                className="transition hover:text-white"
              >
              ...
              <a
                href="https://www.tiktok.com/@orhaner__"
                target="_blank"
                rel="noreferrer"
                className="transition hover:text-white"
              >
        ...
        <div className="mx-auto grid min-h-[100vh] max-w-7xl items-center gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-10">
          <div className="relative z-10 pt-10 lg:pt-0">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/70 sm:text-lg">
              Güçlü vokal, karanlık atmosfer, duygusal sözler ve modern sound.
              Müzikler, klipler, konser tarihleri, galeri, biyografi ve iletişim
              alanları tek bir premium deneyimde buluşuyor.
            </p>

            <div className="mt-9 flex flex-wrap gap-4">
              <a
                href="#music"
                className="rounded-2xl bg-white px-7 py-3.5 text-sm font-semibold text-black transition hover:scale-[1.03]"
              >
                Şarkıları Dinle
              </a>
              <a
                href="#contact"
                className="rounded-2xl border border-white/15 bg-white/5 px-7 py-3.5 text-sm font-semibold text-white transition hover:bg-white/10"
              >
                İletişim
              </a>
              <a
      ...
      <section id="music" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-10">
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6">
            <div className="mb-6">
              ...
              <div className="text-sm text-white/50">
                YouTube üzerinden dinlenebilir.
              </div>
            </div>
      ...
      <section id="about" className="border-y border-white/10 bg-white/[0.03]">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-10">
          <div>
            <div className="text-xs uppercase tracking-[0.35em] text-white/45">
              Hakkında
            </div>
            <h2 className="mt-3 text-3xl font-black sm:text-5xl">
              Sesini hikâyeye dönüştüren bir sanatçı
            </h2>
            <p className="mt-6 max-w-4xl text-base leading-8 text-white/70">
              Orhaner; duygusal anlatımı, güçlü sahne enerjisi ve modern
              altyapılarla şekillenen tarzıyla dikkat çeken yeni nesil bir
              sanatçı. Müziğinde karanlık atmosferi, gerçek duyguları ve modern
              sound çizgisini bir araya getirir.
            </p>
            <p className="mt-4 max-w-4xl text-base leading-8 text-white/70">
              Her parçada kendi dünyasını yansıtan Orhaner, görsel dili ve sahne
              enerjisiyle dinleyicisinde iz bırakan bir atmosfer kurmayı
              hedefliyor.
            </p>
          </div>
      ...
      <section id="shows" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-10">
        <div className="mb-10">
          <div className="text-xs uppercase tracking-[0.35em] text-white/45">
            Etkinlikler
          </div>
          <h2 className="mt-3 text-3xl font-black sm:text-5xl">
            Yaklaşan Sahne Tarihleri
          </h2>
        </div>
            ...
            {gallery.map((src, i) => (
              ...
              >
                <img
                  ...
                  className="h-[420px] w-full object-cover transition duration-500 hover:scale-105 sm:h-[520px]"
                />
              </div>
            ))}
          </div>
      ...
      <section id="contact" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-10">
        <div className="grid gap-8 lg:grid-cols-[1fr_1.1fr]">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-black sm:text-5xl">
              Booking, iş birliği ve menajerlik
            </h2>
            <p className="mt-6 max-w-xl text-base leading-8 text-white/70">
              Booking, iş birlikleri ve profesyonel iletişim için aşağıdaki
              kanallar üzerinden doğrudan bağlantı kurulabilir.
            </p>

            <div className="mt-8 space-y-4 text-sm text-white/75">
              <a
                href="mailto:booking@orhaner.com"
                className="block rounded-2xl border border-white/10 bg-white/5 p-4 transition hover:bg-white/10"
              >
                E-posta: booking@orhaner.com
              </a>
              <a
                href="https://www.instagram.com/orhaner___?hl=de"
                target="_blank"
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-2 text-sm text-white/55">
              Mesaj göndermek için form alanı.
            </div>
            <div className="mt-6 grid gap-4">
              <input
                className="rounded-2xl border border-white/10 bg-black/40 px-4 py-4 outline-none placeholder:text-white/35"
              ...
              />
              <textarea
                className="min-h-[170px] rounded-2xl border border-white/10 bg-black/40 px-4 py-4 outline-none placeholder:text-white/35"
      ...
      <footer className="border-t border-white/10 bg-black/60">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-8 text-sm text-white/50 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-10">
          <div>
          ...
          <div className="flex flex-wrap gap-5">
            ...
            <a href="#shows" className="hover:text-white">
              Etkinlikler
            </a>
      ...
      {musicStarted && (
        <div className="fixed bottom-0 left-0 h-0 w-0 overflow-hidden opacity-0">
          <iframe
